    ...
    var DocumentCloner = /** @class */ (function () {
        ...
        DocumentCloner.prototype.toIFrame = function (ownerDocument, windowSize) {
            ...
            var iframeLoad = iframeLoader(iframe).then(function () { return __awaiter(_this, void 0, void 0, function () {
                var onclone, referenceElement, fontReadyTimer_1, pollCnt_1;
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, new Promise(function (resolve, reject) {
                                    ...
                                    var poll = function () {
                                        if (document.fonts.status === 'loaded' || pollCnt_1 === 10)
                                            resolve(null);
                                        else {
                                            pollCnt_1++;
                                            fontReadyTimer_1 = setTimeout(poll, 1000);
                                        }
                                    };
                                    poll();
                                })];
        ...
        Logger.prototype.debug = function () {
            ...
            if (this.enabled) {
                ...
                if (typeof window !== 'undefined' && window.console && typeof console.debug === 'function') {
                    // eslint-disable-next-line no-console
                    console.debug.apply(console, __spreadArray([this.id, this.getTime() + "ms"], args, false));
                }
                else {
        ...
        Logger.prototype.info = function () {
            ...
            if (this.enabled) {
                ...
                if (typeof window !== 'undefined' && window.console && typeof console.info === 'function') {
                    // eslint-disable-next-line no-console
                    console.info.apply(console, __spreadArray([this.id, this.getTime() + "ms"], args, false));
                }
            }
        };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        Logger.prototype.warn = function () {
            ...
            if (this.enabled) {
                ...
                if (typeof window !== 'undefined' && window.console && typeof console.warn === 'function') {
                    // eslint-disable-next-line no-console
                    console.warn.apply(console, __spreadArray([this.id, this.getTime() + "ms"], args, false));
                }
                else {
                    this.info.apply(this, args);
                }
        ...
        Logger.prototype.error = function () {
            ...
            if (this.enabled) {
                ...
                if (typeof window !== 'undefined' && window.console && typeof console.error === 'function') {
                    // eslint-disable-next-line no-console
                    console.error.apply(console, __spreadArray([this.id, this.getTime() + "ms"], args, false));
                }
                else {
                    this.info.apply(this, args);
                }
