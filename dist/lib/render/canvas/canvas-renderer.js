...
var CanvasRenderer = /** @class */ (function (_super) {
    ...
    CanvasRenderer.prototype.renderNode = function (paint) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if ((0, bitwise_1.contains)(paint.container.flags, 16 /* DEBUG_RENDER */)) {
                            debugger;
                        }
    ...
    CanvasRenderer.prototype.renderTextWithLetterSpacing = function (text, letterSpacing, baseline) {
        ...
        if (letterSpacing === 0) {
            ...
            var letters = (0, text_segmentation_1.splitGraphemes)(text.text);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 14:
                        ...
                        if (!(0, bitwise_1.contains)(container.styles.display, 2048 /* LIST_ITEM */)) return [3 /*break*/, 20];
    ...
    CanvasRenderer.prototype.renderStackContent = function (stack) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_p) {
                switch (_p.label) {
                    case 0:
                        if ((0, bitwise_1.contains)(stack.element.container.flags, 16 /* DEBUG_RENDER */)) {
                            debugger;
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        border = borders_1[_i];
                        if (!(border.style !== 0 /* NONE */ && !(0, color_1.isTransparent)(border.color) && border.width > 0)) return [3 /*break*/, 11];
